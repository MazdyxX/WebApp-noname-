...
adminpage = Blueprint('adminpage', __name__, template_folder='templates', static_folder='static')
...
def teacherlist(teacher_id):
  ...
  return render_template('teacherlist')
