...
def register():
    error=''
    if request.method == 'POST':
        data = register_teacher(request.form['teacher_code'],request.form['teacher_pass'],request.form['email'],request.form['password'],)
...
def class_list(class_id, command = None, student_name = None):
    #if command and student_name
